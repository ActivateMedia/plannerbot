...
//    console.log(event.object);
    ...
    event.subject.text !== "") {
          ...
          if(event.action.verb.tense === "present") {
            if(event.subject.text === "I" && event.action.verb.text === "have") {
            ...
            } else if(event.subject.text === "I" && event.action.verb.negated === "1") {
              // I replace "I'm not" with "Andrea is not"
              event.summary = event.summary.replace("I\’m not", self.slack.members[event.message.user].first_name+" is not ");
            ...
            } else if(event.subject.text === "I" && (event.action.text.indexOf('m ') >= 0 || event.action.text === "m")) {
              // I replace "I'm" with "Andrea is"
              event.summary = event.summary.replace("I\’m", self.slack.members[event.message.user].first_name+" is");
            } else if(event.subject.text === "I" && (event.action.text === "ll be" || event.action.text === "will")) {
              ...
              event.summary = event.summary.replace("I\’ll", self.slack.members[event.message.user].first_name+" will");
            }            
          }
          
          // Future
          if(event.action.verb.tense === "future") {
            if(event.subject.text === "I" && (event.action.text.indexOf('m ') >= 0 || event.action.text === "m")) {
              // I replace "I'm" with "Andrea is"
              event.summary = event.summary.replace("I\’m", self.slack.members[event.message.user].first_name+" is");
              ...
              event.summary = event.summary.replace(event.subject.text, self.slack.members[event.message.user].first_name);
                ...
                if(event.summary.indexOf("I\’m") >= 0) {
                   event.summary = event.summary.replace("I\’m", self.slack.members[event.message.user].first_name+" is");
                } else if(event.summary.indexOf("I\’ll") >= 0) {
                   event.summary = event.summary.replace("I\’ll", self.slack.members[event.message.user].first_name+" will");
                } else {
